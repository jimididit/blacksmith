...
Minor release: set gallery, `blacksmith sign`, and fail-closed unsigned remote `--url` installs.

### Added

- `blacksmith gallery` — curated index (bundled + optional `--refresh` from GitHub), `list` / `info` / `install` / `apply` / `validate`
...
[Unreleased]: https://github.com/jimididit/blacksmith/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/jimididit/blacksmith/compare/v0.6.0...v0.7.0
